...
import com.nut.teamradar.adapter.ContactAdapter;
import com.nut.teamradar.domain.HXUser;
import com.nut.teamradar.widget.Sidebar;
...
//		}
	...
	private void getContactList() {
		contactList.clear();
		Map<String, HXUser> users = TeamRadarApplication.getInstance().getContactList();
