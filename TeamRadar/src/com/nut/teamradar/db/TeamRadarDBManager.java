...
public class TeamRadarDBManager {
    static private TeamRadarDBManager dbMgr = new TeamRadarDBManager();
    ...
    public static synchronized TeamRadarDBManager getInstance(){
        return dbMgr;
    }
     ...
     * @param contactList
     */
    synchronized public void saveContactList(List<HXUser> contactList) {
     ...
     * @return
     */
    synchronized public Map<String, HXUser> getContactList() {
     ...
     * @param user
     */
    synchronized public void saveContact(HXUser user){
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(UserDao.COLUMN_NAME_ID, user.getUsername());
        if(user.getNick() != null)
