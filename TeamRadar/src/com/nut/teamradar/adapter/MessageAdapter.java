...
import com.nut.teamradar.AlertDialog;
import com.nut.teamradar.ChatActivity;
import com.nut.teamradar.Constant;
import com.nut.teamradar.ContextMenu;
import com.nut.teamradar.TeamRadarHXSDKHelper;
import com.nut.teamradar.R;
import com.nut.teamradar.ShowBigImage;
import com.nut.teamradar.ShowNormalFileActivity;
import com.nut.teamradar.ShowVideoActivity;
import com.nut.teamradar.controller.HXSDKHelper;
import com.nut.teamradar.task.LoadImageTask;
import com.nut.teamradar.task.LoadVideoImageTask;
...
public class MessageAdapter extends BaseAdapter{
	...
	public int getItemViewType(int position) {
		...
		if (message.getType() == EMMessage.Type.TXT) {
			...
			else if(((TeamRadarHXSDKHelper)HXSDKHelper.getInstance()).isRobotMenuMessage(message))
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if ((chatType == ChatType.GroupChat || chatType == ChatType.ChatRoom) && message.direct == EMMessage.Direct.RECEIVE){
		    //demo閲屼娇鐢╱sername浠ｇ爜nick
			String ActivityName="dumy";
			ActivityName = UserUtils.GetUserNameBySub(Encrypt.GetDecryptString(message.getFrom()))	;
			if(ActivityName == null)
				ActivityName = Encrypt.GetDecryptString(message.getFrom());
					
			holder.tv_usernick.setText(ActivityName);
		}
